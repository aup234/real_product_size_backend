defmodule RealProductSizeBackendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RealProductSizeBackendWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RealProductSizeBackendWeb.Gettext, "errors", msg, opts)
    end
  end
